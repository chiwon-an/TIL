# 문제
# 주어진 문자열에서 요구 사항에 맞게 특정 부분을 추출하여 변수에 할당하고, 이를 출력하는 프로그램을 작성하시오.
...
fist_word = password[28:35]
second_word = password[113:118]
four_word = password[68:65:-1]
third_word = password[325:322:-1]
fifth_word = password[365:371]

print(f'{fist_word} {second_word} {third_word} {four_word} {fifth_word}')